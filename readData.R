...
#
# NOTE: In order to load data efficiently (thus allowing easy iteration on
# the plotting code), this caches the filtered data in the file
...
# "1/2/2007" or "2/2/2007", writes them to data/household_power_consumption_filtered.txt
# with the header row from the source file prepended.
